...
enum struct SpongeID
{
	Sponge = 0,
	WetSponge = 1
};

enum struct SandstoneID
{
	Sandstone = 0,
	ChiseledSandstone = 1,
	SmoothSandstone = 2
...
enum struct CobblestoneWallID
{
	CobblestoneWall = 0,
	MossyCobblestoneWall = 1
};

enum struct QuartzID
{
	Quartz = 0,
	ChiseledQuartz = 1,
	PillarQuartz = 2
