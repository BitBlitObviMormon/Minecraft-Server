...
enum struct BossBarNumDividers
{
	None = 0,
	Six = 1,
	Ten = 2,
...
enum struct ScoreboardPosition
{
	List = 0,
	Sidebar = 1,
	BelowName = 2
...
enum struct EntityEquipmentSlot
{
	MainHand = 0,
	OffHand = 1,
	Boots = 2,
