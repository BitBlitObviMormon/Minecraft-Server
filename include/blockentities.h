...
enum struct BlockEntityActionID
{
	NoteBlock = 25,
	Piston = 33,
	StickyPiston = 29,
 ...
 * A minecraft block entity *
 ****************************/
struct CommandBlock : public BlockEntity
{
public:
};
...
public:
	Byte playersUsing;
	Chest(BlockEntityType type) : BlockEntity(type), playersUsing(0) {}
};
